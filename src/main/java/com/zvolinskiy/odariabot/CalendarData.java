...
public class CalendarData {
    private static final String APPLICATION_NAME = "odariabot";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = CalendarData.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
     ...
     * */
    public static String getDataFromCalendar(String colorId, DateTime date) throws IOException, GeneralSecurityException {
